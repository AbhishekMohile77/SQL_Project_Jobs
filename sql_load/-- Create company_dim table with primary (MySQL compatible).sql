...
-- Set ownership of the tables to the mysql user
ALTER TABLE company_dim OWNER to mysql;
ALTER TABLE skills_dim OWNER to mysql;
ALTER TABLE job_postings_fact OWNER to mysql;
ALTER TABLE skills_job_dim OWNER to mysql;
